...
printInfo "Installing OpenAI Agents"
...
printInfo "OpenAI Agents version: $(python -c "from importlib.metadata import version; print(version('openai-agents'))")"
printInfo "    conda activate agents"
printInfo "OpenAI Agents installed"
