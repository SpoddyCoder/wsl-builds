...
This build directory exists to drive deterministic scenarios for the **automated builds review** (run `./review/component-review.sh` from the repo root, e.g. `./review/component-review.sh fixture-review happy-path`) and the maintainer debug harness (`./review/review-debug.sh`). It is **not** a real environment build.
