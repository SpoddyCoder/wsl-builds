...
| [ai-agents](builds/ai-agents/) | **setup-env**: conda `agents` env,<br/>python-dotenv, httpx,<br/>jupyter, pydantic<br>**langchain**: LangChain,<br/>optional Ollama /<br/>llama-cpp-python<br/>integrations<br>**openai-agents**: OpenAI<br/>Agents SDK<br>**langsmith**: LangSmith Python SDK<br/>(LangSmith Cloud)<br>**langfuse**: Langfuse Python SDK<br/>(Langfuse Cloud) | |
