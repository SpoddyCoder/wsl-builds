...
| ----- | ------------------------------------ | --------------- |
| [ai](builds/ai/) | **cuda124**: CUDA 12.4<br>**cuda132**: CUDA 13.2<br>**ollama**<br>**huggingface-cli**: Hub `hf` CLI (pip)<br>**llama-cpp**: build from source, optional CUDA<br>**langchain**: conda `agents` env,<br/>optional Ollama / llama-cpp-python<br/>integrations<br>**langfuse**: Langfuse Python SDK<br/>(conda `agents`, Langfuse Cloud)<br>**cuda-wsl-lib-symlinks**: fix 'not symlinks' issue | **ollama**: `OLLAMA_MODELS`<br/>**huggingface-cli**: `HF_HOME`,<br/>`HF_HUB_CACHE` |
