...
| [ai-agents](builds/ai-agents/) | **setup-env**: conda `agents` env,<br/>python-dotenv, httpx,<br/>jupyter, pydantic<br>**langchain**: LangChain core<br>**langchain-ollama**: Ollama<br/>integration<br>**langchain-llama-cpp**:<br/>langchain-community +<br/>llama-cpp-python<br>**langgraph**: LangGraph<br>**openai-agents**: OpenAI<br/>Agents SDK<br>**langsmith**: LangSmith Python SDK<br/>(LangSmith Cloud)<br>**langfuse**: Langfuse Python SDK<br/>(Langfuse Cloud) | |
