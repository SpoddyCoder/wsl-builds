...
| `dev-ai.wslb` <br/>AI build            | **system:** update, essentials, qol, symlinks, apt-mirror-switch <br/>**dev:** essentials, cursor <br/>**devops:** docker <br/>**dev-bash:** shellcheck, bats <br/>**ai:** cuda132, ollama <br/>**dev-python:** python3, conda               |
